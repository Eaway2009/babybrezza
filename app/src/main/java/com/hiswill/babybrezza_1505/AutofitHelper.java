...
//    public ArrayList<OnTextSizeChangeListener> mListeners;
    public CopyOnWriteArrayList<OnTextSizeChangeListener> mListeners;
    ...
    public AutofitHelper addOnTextSizeChangeListener(OnTextSizeChangeListener listener) {
        if (mListeners == null) {
            mListeners = new CopyOnWriteArrayList<OnTextSizeChangeListener>();
        }
